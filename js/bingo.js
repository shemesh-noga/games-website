...
function sentenceRandom() {
  ...
  for (let x = 1; x < 17; x++) {
    ...
    if (thisSentences.innerHTML === sent) {
      thisSentences.onclick = function () {
        ClickBingo();
      };
      function ClickBingo() {
        ...
        for (let x = 1; x < 17; x++) {
          ...
          var numberOfGreen = 0;
          for (let y = 0; y < 4; y++) {
            const element = document.getElementById(`itemm${1 + y}`).style
              .backgroundColor;
            console.log(element);
            if (row2 === 1) {
              if (
                document.getElementById(`itemm${1 + y}`).style
            ...
            if (row2 === 2) {
              if (
                document.getElementById(`itemm${5 + y}`).style
                  .backgroundColor == "green"
              ) {
                numberOfGreen++;
              }
            ...
            if (row2 === 3) {
              if (
                document.getElementById(`itemm${9 + y}`).style
                  .backgroundColor == "green"
              ) {
                numberOfGreen++;
              }
            ...
            if (row2 === 4) {
              if (
                document.getElementById(`itemm${13 + y}`).style
                  .backgroundColor == "green"
              ) {
                numberOfGreen++;
              }
          ...
          for (let z = 0; z < 16; z += 4) {
            if (column2 === 1) {
              if (
                document.getElementById(`itemm${1 + z}`).style
                  .backgroundColor == "green"
              ) {
                columnnumberOfGreen++;
              }
            ...
            if (column2 === 2) {
              if (
                document.getElementById(`itemm${2 + z}`).style
                  .backgroundColor == "green"
              ) {
                columnnumberOfGreen++;
              }
            ...
            if (column2 === 3) {
              if (
                document.getElementById(`itemm${3 + z}`).style
                  .backgroundColor == "green"
              ) {
                columnnumberOfGreen++;
              }
            ...
            if (column2 === 4) {
              if (
                document.getElementById(`itemm${4 + z}`).style
                  .backgroundColor == "green"
              ) {
                columnnumberOfGreen++;
              }
    ...
    for (let i = 1; i < 17; i++) {
      ...
      if (thisSentence.innerHTML === sent) {
        ...
        for (let j = 0; j < 4; j++) {
          if (row === 1) {
            if (
              document.getElementById(`item${1 + j}`).style.backgroundColor ==
              "red"
            ) {
              numberOfRed++;
            }
          ...
          if (row === 2) {
            if (
              document.getElementById(`item${5 + j}`).style.backgroundColor ==
              "red"
            ) {
              numberOfRed++;
            }
          ...
          if (row === 3) {
            if (
              document.getElementById(`item${9 + j}`).style.backgroundColor ==
              "red"
            ) {
              numberOfRed++;
            }
          ...
          if (row === 4) {
            if (
              document.getElementById(`item${13 + j}`).style.backgroundColor ==
              "red"
            ) {
              numberOfRed++;
            }
        ...
        for (let t = 0; t < 16; t += 4) {
          if (column === 1) {
            if (
              document.getElementById(`item${1 + t}`).style.backgroundColor ==
              "red"
            ) {
              columnNumberOfRed++;
            }
          ...
          if (column === 2) {
            if (
              document.getElementById(`item${2 + t}`).style.backgroundColor ==
              "red"
            ) {
              columnNumberOfRed++;
            }
          ...
          if (column === 3) {
            if (
              document.getElementById(`item${3 + t}`).style.backgroundColor ==
              "red"
            ) {
              columnNumberOfRed++;
            }
          ...
          if (column === 4) {
            if (
              document.getElementById(`item${4 + t}`).style.backgroundColor ==
              "red"
            ) {
              columnNumberOfRed++;
            }
